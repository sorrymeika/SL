    ...
    <ul class="buywrap bill">
        ...
        <li>
            ...
            <div class="con">
                ...
                <div sn-binding="html:nextDiscount" class="buy_discount"></div>
            </div>
        </li>
        <li>
        ...
        <li class="multi">
            ...
            <p class="bill_li"><span class="label" sn-binding="html:discountInfo"></span><em class="con" sn-binding="html:discount|concat:'元'"></em></p>
            <p class="bill_li"><span class="label">合计</span><em class="con" sn-binding="html:total_time|mul:basic_info.price|minus:coupon_price|minus:discount|max:0|concat:'元'"></em></p>
        </li>
    </ul>
</div>
